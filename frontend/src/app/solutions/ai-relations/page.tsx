                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Analyzing customer sentiment...</p>
                    </div>
                  </div>
                  
                  <div className="space-y-4">
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border-l-4 border-blue-500">
                      <p className="text-sm text-gray-700 font-medium">🎯 High-value opportunity detected</p>
                      <p className="text-xs text-gray-600 mt-1">Customer Sarah Johnson shows 89% likelihood to upgrade based on recent engagement patterns</p>
                    </div>
                    
                    <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-xl border-l-4 border-green-500">
                      <p className="text-sm text-gray-700 font-medium">✅ Retention strategy deployed</p>
                      <p className="text-xs text-gray-600 mt-1">Proactive outreach initiated for 3 at-risk customers with personalized offers</p>
                    </div>
                    
                    <div className="bg-gradient-to-r from-purple-50 to-violet-50 p-4 rounded-xl border-l-4 border-purple-500">
                      <p className="text-sm text-gray-700 font-medium">📊 Sentiment analysis complete</p>
                      <p className="text-xs text-gray-600 mt-1">Overall customer satisfaction increased by 12% this quarter</p>
                    </div>
                  </div>
                </div>
              </div>
