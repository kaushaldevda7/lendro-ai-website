    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100">
        <section className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-gradient-to-r from-indigo-600/10 via-blue-500/10 to-purple-700/10 rounded-full blur-3xl"></div>
            ...
            <div className="text-center mb-1">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                <span className="bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-700 bg-clip-text text-transparent">
                  Reinforcement Learning in Loan Pricing
                </span>
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                A deep dive into the technical architecture behind reinforcement learning in loan pricing and its practical applications in credit decisioning.
              </p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-gray-200/50">
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-700 leading-relaxed mb-8 font-medium">
                  A deep dive into the technical architecture behind reinforcement learning in loan pricing and its practical applications in credit decisioning. This is an exploration of one of the most important topics in modern lending technology.
                </p>

                <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-8 border border-blue-200/50 mb-12">
                ...
                <div className="bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-700 rounded-2xl p-8 text-white mb-12">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-white rounded-2xl p-8 border border-blue-200/50 text-center mt-12">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                      href="/contact"
                      className="px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold rounded-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                    >
                      Talk to an Expert
                    </Link>
                    <Link
                      href="/blog"
                      className="px-6 py-3 border-2 border-blue-500 text-blue-600 font-semibold rounded-xl hover:bg-blue-50 transition-all duration-300"
                    >
                      Read More Articles
                    </Link>
                  </div>
        ...
        {showScrollTop && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-50 flex items-center justify-center"
          >
