          ...
          <div className="container mx-auto px-4 max-w-4xl relative z-10">
            ...
            <div className="text-center mb-1">
              <div className="inline-flex items-center px-4 py-2 bg-sky-50 rounded-full border border-sky-200/50 shadow-sm mb-6">
                ...
                <span className="text-sm font-semibold text-sky-700">Personal Journey</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="block text-gray-900 text-3xl md:text-4xl lg:text-5xl mt-2">
                  Lessons from Distributed Startup Life
                </span>
              </h1>

              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                How we built a cohesive, high-performing team across time zones—and the tools and rituals that make it work.
              </p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-gray-200/50">
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-700 leading-relaxed mb-8 font-medium">
                  How we built a cohesive, high-performing team across time zones—and the tools and rituals that make it work. This is an exploration of one of the most important topics in modern lending technology.
                </p>
