            ...
            <div className="text-center mb-1">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                <span className="bg-gradient-to-r from-indigo-500 via-blue-600 to-violet-700 bg-clip-text text-transparent">
                  Automating Warehouse Lending
                </span>
                <span className="block text-gray-900 text-3xl md:text-4xl lg:text-5xl mt-2">
                  AI for Lender of Lenders
                </span>
              </h1>

              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                How AI is transforming warehouse lending operations, improving efficiency for the institutions that fund other lenders.
              </p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-gray-200/50">
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-700 leading-relaxed mb-8 font-medium">
                  How AI is transforming warehouse lending operations, improving efficiency for the institutions that fund other lenders. This is an exploration of one of the most important topics in modern lending technology.
                </p>
