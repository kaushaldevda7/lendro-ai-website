    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100">
        <section className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-gradient-to-r from-amber-600/10 via-orange-500/10 to-yellow-700/10 rounded-full blur-3xl"></div>
          ...
          <div className="container mx-auto px-4 max-w-4xl relative z-10">
            ...
            <div className="text-center mb-1">
              <div className="inline-flex items-center px-4 py-2 bg-orange-50 rounded-full border border-orange-200/50 shadow-sm mb-6">
                ...
                <span className="text-sm font-semibold text-orange-700">Technical Deep Dive</span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                <span className="bg-gradient-to-r from-orange-500 via-amber-600 to-yellow-700 bg-clip-text text-transparent">
                  Vector Databases for Credit Risk
                </span>
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                A deep dive into the technical architecture behind vector databases for credit risk and its practical applications in credit decisioning.
              </p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-gray-200/50">
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-700 leading-relaxed mb-8 font-medium">
                  A deep dive into the technical architecture behind vector databases for credit risk and its practical applications in credit decisioning. This is an exploration of one of the most important topics in modern lending technology.
                </p>

                <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl p-8 border border-orange-200/50 mb-12">
                ...
                <div className="bg-gradient-to-r from-orange-500 via-amber-600 to-yellow-700 rounded-2xl p-8 text-white mb-12">
                ...
                <div className="bg-gradient-to-r from-orange-50 to-white rounded-2xl p-8 border border-orange-200/50 text-center mt-12">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                      href="/contact"
                      className="px-6 py-3 bg-gradient-to-r from-orange-500 to-amber-600 text-white font-semibold rounded-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                    >
                      Talk to an Expert
                    </Link>
                    <Link
        ...
        {showScrollTop && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-orange-500 to-amber-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-50 flex items-center justify-center"
          >
