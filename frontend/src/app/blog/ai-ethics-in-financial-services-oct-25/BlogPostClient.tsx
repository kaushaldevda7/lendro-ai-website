          ...
          <div className="container mx-auto px-4 max-w-4xl relative z-10">
            ...
            <header className="text-center mb-1">
              <div className="inline-flex items-center px-4 py-2 bg-cyan-50 rounded-full border border-cyan-200/50 shadow-sm mb-6">
                ...
                <span className="text-sm font-semibold text-cyan-700">{category}</span>
              </div>
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-gray-200/50">
              <div className="prose prose-lg max-w-none">
                ...
                <aside className="bg-gradient-to-r from-cyan-50 to-white rounded-2xl p-8 border border-cyan-200/50 text-center mt-12">
