    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
        <section className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-r from-slate-500/10 via-gray-600/10 to-zinc-700/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-gradient-to-r from-gray-600/10 via-slate-500/10 to-zinc-700/10 rounded-full blur-3xl"></div>
          ...
          <div className="container mx-auto px-4 max-w-4xl relative z-10">
            ...
            <div className="text-center mb-1">
              <div className="inline-flex items-center px-4 py-2 bg-slate-50 rounded-full border border-slate-200/50 shadow-sm mb-6">
                <div className="w-2 h-2 bg-slate-500 rounded-full mr-3 animate-pulse"></div>
                <span className="text-sm font-semibold text-slate-700">Technical Deep Dive</span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                <span className="bg-gradient-to-r from-slate-500 via-gray-600 to-zinc-700 bg-clip-text text-transparent">
                  API Design for Lending Platforms
                </span>
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                A deep dive into the technical architecture behind api design for lending platforms and its practical applications in credit decisioning.
              </p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-gray-200/50">
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-700 leading-relaxed mb-8 font-medium">
                  A deep dive into the technical architecture behind api design for lending platforms and its practical applications in credit decisioning. This is an exploration of one of the most important topics in modern lending technology.
                </p>

                <div className="bg-gradient-to-r from-slate-50 to-slate-100 rounded-2xl p-8 border border-slate-200/50 mb-12">
                ...
                <div className="bg-gradient-to-r from-slate-500 via-gray-600 to-zinc-700 rounded-2xl p-8 text-white mb-12">
                ...
                <div className="bg-gradient-to-r from-slate-50 to-white rounded-2xl p-8 border border-slate-200/50 text-center mt-12">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                      href="/contact"
                      className="px-6 py-3 bg-gradient-to-r from-slate-500 to-gray-600 text-white font-semibold rounded-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                    >
                      Talk to an Expert
                    </Link>
                    <Link
                      href="/blog"
                      className="px-6 py-3 border-2 border-slate-500 text-slate-600 font-semibold rounded-xl hover:bg-slate-50 transition-all duration-300"
                    >
                      Read More Articles
                    </Link>
                  </div>
        ...
        {showScrollTop && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-slate-500 to-gray-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-50 flex items-center justify-center"
          >
