    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-100">
        <section className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-r from-emerald-500/10 via-green-600/10 to-teal-700/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-gradient-to-r from-green-600/10 via-emerald-500/10 to-teal-700/10 rounded-full blur-3xl"></div>
          ...
          <div className="container mx-auto px-4 max-w-4xl relative z-10">
            ...
            <div className="text-center mb-1">
              <div className="inline-flex items-center px-4 py-2 bg-emerald-50 rounded-full border border-emerald-200/50 shadow-sm mb-6">
                <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3 animate-pulse"></div>
                <span className="text-sm font-semibold text-emerald-700">Technical Deep Dive</span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                <span className="bg-gradient-to-r from-emerald-500 via-green-600 to-teal-700 bg-clip-text text-transparent">
                  Multi-Modal AI in Underwriting
                </span>
                <span className="block text-gray-900 text-3xl md:text-4xl lg:text-5xl mt-2">
                  Processing Documents, Images, and Data
                </span>
              </h1>

              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                Understanding the engineering challenges and solutions in implementing multi-modal ai in underwriting for financial services.
              </p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-gray-200/50">
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-700 leading-relaxed mb-8 font-medium">
                  Understanding the engineering challenges and solutions in implementing multi-modal ai in underwriting for financial services. This is an exploration of one of the most important topics in modern lending technology.
                </p>

                <div className="bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-2xl p-8 border border-emerald-200/50 mb-12">
                ...
                <div className="bg-gradient-to-r from-emerald-500 via-green-600 to-teal-700 rounded-2xl p-8 text-white mb-12">
                ...
                <div className="bg-gradient-to-r from-emerald-50 to-white rounded-2xl p-8 border border-emerald-200/50 text-center mt-12">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                      href="/contact"
                      className="px-6 py-3 bg-gradient-to-r from-emerald-500 to-green-600 text-white font-semibold rounded-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                    >
                      Talk to an Expert
                    </Link>
                    <Link
                      href="/blog"
                      className="px-6 py-3 border-2 border-emerald-500 text-emerald-600 font-semibold rounded-xl hover:bg-emerald-50 transition-all duration-300"
                    >
                      Read More Articles
                    </Link>
                  </div>
        ...
        {showScrollTop && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-50 flex items-center justify-center"
          >
