...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://lendro.ai/blog/auto-lending-market-dynamics-nov-25',
  },
  openGraph: {
    title: 'Auto Lending Market Dynamics: Vehicle Finance Evolution',
    description: 'Data-driven analysis of auto lending market dynamics and what the trends mean for lenders and investors.',
    url: 'https://lendro.ai/blog/auto-lending-market-dynamics-nov-25',
    siteName: 'Lendro.AI',
    type: 'article',
...
const jsonLd = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://lendro.ai/blog/auto-lending-market-dynamics-nov-25',
  },
  keywords: 'Auto, Vehicle, Market, Trends, AI lending, fintech, credit risk, Lendro.AI, Market Analysis',
