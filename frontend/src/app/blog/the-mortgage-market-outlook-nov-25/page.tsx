...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://lendro.ai/blog/the-mortgage-market-outlook-nov-25',
  },
  openGraph: {
    title: 'The Mortgage Market Outlook: Housing Finance Trends',
    description: 'Data-driven analysis of the mortgage market outlook and what the trends mean for lenders and investors.',
    url: 'https://lendro.ai/blog/the-mortgage-market-outlook-nov-25',
    siteName: 'Lendro.AI',
    type: 'article',
...
const jsonLd = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://lendro.ai/blog/the-mortgage-market-outlook-nov-25',
  },
  keywords: 'Mortgage, Housing, Outlook, Trends, AI lending, fintech, credit risk, Lendro.AI, Market Analysis',
